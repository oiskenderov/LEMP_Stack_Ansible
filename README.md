...
<p align="center">
  <img width="90%" src="https://github.com/oiskenderov/LEMP_Stack_Ansible/blob/main/images/compose.gif">
</p>
...
> **Note**  
> You can change the version and tag of images in [.env](https://github.com/oiskenderov/LEMP_Stack_Ansible/blob/main/.env) file.
...
```console
git clone git@github.com:oiskenderov/LEMP_Stack_Ansible.git
```
...
Now for test, Open `http://localhost:8090` `http://localhost:80` for Nginx. You should see the default Nginx welcome page.
...
This Docker Compose and Ansible configuration was created in 2024 by Orkhan Iskandarov.

## Contributors

<a href="https://github.com/oiskenderov/LEMP_Stack_Ansible">
  <img src="https://contrib.rocks/image?repo=oiskenderov/LEMP_Stack_Ansible"/>
</a>
